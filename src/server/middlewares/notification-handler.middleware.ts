...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'event.update': {
    roles: ['platform-owner', 'event-organizer'],
    key: 'event-updated',
    tenantPath: ['platform', 'event'],
    userPath: [],
  },
  'subscription.update': {
    roles: ['platform-owner', 'event-organizer'],
    key: 'user-subscription-status',
    tenantPath: ['platform', 'event', 'subscription'],
    userPath: [],
  },
  'attendance.update': {
    roles: ['platform-owner', 'event-organizer'],
    key: 'event-attendance',
    tenantPath: ['platform', 'event', 'attendance'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['platform-owner', 'event-organizer'];
