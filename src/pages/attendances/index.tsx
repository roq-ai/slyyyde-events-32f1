  ...
  const columns: ColumnType[] = [
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.check_in_time ? format(parseISO(record?.check_in_time as unknown as string), 'dd-MM-yyyy') : '',
    },
    {
      id: 'check_out_time',
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.check_out_time ? format(parseISO(record?.check_out_time as unknown as string), 'dd-MM-yyyy') : '',
    },
